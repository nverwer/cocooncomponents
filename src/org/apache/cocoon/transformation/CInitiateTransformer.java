...
//    this.resolver = resolver;
  ...
  private class CThread extends Thread {
    ...
    public CThread(String src, SourceResolver resolver, Logger logger, String contextDir, Parameters configParameters, SourceParameters requestParameters)
      throws Exception
    {
    ...
    public void run()
    {
      ...
      sourceFactory.enableLogging(logger);
      Source source = null;
...
*/
      ...
      if (source != null) sourceFactory.release(source);
      try {
