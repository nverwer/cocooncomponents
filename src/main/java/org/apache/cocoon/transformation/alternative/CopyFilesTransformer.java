 ...
 * file element of the <code>http://org.apache.cocoon.transformation/alternative/copy/1.0</code>
 * namespace.
 * @author Geert Josten (Daidalos BV)
 *
 * Usage:
 *   <copy:file src="mySourceFileOrDirectoryName" target="myTargetFileOrDirectoryName" xmlns:copy="http://org.apache.cocoon.transformation/alternative/copy/1.0"/>
 */
public class CopyFilesTransformer extends AbstractTransformer {
  ...
  public static final String COPY_FILES_NS =
    "http://org.apache.cocoon.transformation/alternative/copy/1.0";
